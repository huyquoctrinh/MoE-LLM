...
model_type="auto"
model_name_or_path="/dev/shm/test/llama-moe/data/llama_moe_v1"
dataset_dir_or_path="/dev/shm/test/llama-moe/data/deita/deita_6k.json"

    # comment="llama-moe 2/8, deita, w/ balance loss, w/ freeze gate, w/ gate noise"
base_dir="/dev/shm/test/llama-moe/output/llama_moe_sft"
...
python -m smoe.entrypoint.sft.train_sft \
    --do_train \
    --freeze_gate True \
